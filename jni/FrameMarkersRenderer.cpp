...
Java_org_ronhuang_vistroller_FrameMarkersRenderer_setActivityPortraitMode(JNIEnv *, jobject, jboolean isPortrait)
{
...
JNIEXPORT void JNICALL
Java_org_ronhuang_vistroller_FrameMarkersRenderer_configureVideoBackground(JNIEnv* env, jobject obj)
{
    LOG("Java_org_ronhuang_vistroller_FrameMarkersRenderer_configureVideoBackground");
    configureVideoBackground();
}


JNIEXPORT void JNICALL
Java_org_ronhuang_vistroller_FrameMarkersRenderer_setScreenSize(JNIEnv* env, jobject obj, jint width, jint height)
{
    LOG("Java_org_ronhuang_vistroller_FrameMarkersRenderer_updateScreenSize");
...
JNIEXPORT void JNICALL
Java_org_ronhuang_vistroller_FrameMarkersRenderer_configureProjectMatrix(JNIEnv* env, jobject obj)
{
    LOG("Java_org_ronhuang_vistroller_FrameMarkersRenderer_configureProjectMatrix");
